...
class SharedPreferenceManager(private val context: Context) {
    ...
    fun isEInkModeEnabled(): Boolean {
        return preferences.getBoolean("einkMode", true)
    }

    fun isEInkHighContrast(): Boolean {
        return preferences.getBoolean("einkHighContrast", true)
    }

    fun getEInkRefreshMode(): String? {
        return preferences.getString("einkRefreshMode", "partial")
    }
    ...
    fun setCustomFontPath(path: String?) {
        preferences.edit {
            putString("customFontPath", path)
        }
    }

    fun isCustomFontEnabled(): Boolean {
        return preferences.getBoolean("enableCustomFont", false)
    }

    // 简体中文日期格式
    fun getChineseDateFormat(): String? {
        return preferences.getString("chineseDateFormat", "full")
    }
