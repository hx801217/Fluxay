...
class SettingsFragment : PreferenceFragmentCompat(), TitleProvider {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        val einkSettings = findPreference<Preference>("einkSettings")
        ...
        einkSettings?.onPreferenceClickListener =
            Preference.OnPreferenceClickListener {
                uiUtils.switchFragment(requireActivity(), EInkSettingsFragment())
                true }
